...
export default function BoardingHousesPage() {
  ...
  useEffect(() => {
    fetch("/api/properties?type=Boarding House")
      .then((res) => res.json())
      .then((data) => {
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Browse boarding houses in Zambia. Search, filter, and book your next stay."
        />
      </Head>
      <div
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
              {filtered
                ...
                .map((property) => (
                  <Link
                    href={`/boarding-houses/${property.id}`}
                    key={property.id}
                  >
