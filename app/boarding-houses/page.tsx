...
export default function BoardingHousesPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col p-6">
      <Head>
        <title>Boarding Houses - Jconnect Zambia</title>
      </Head>

      <h1 className="text-4xl font-bold mb-6 text-center text-pink-700">Boarding Houses</h1>
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
            {filtered
              ...
              .map((property) => (
                <Link href={`/boarding-houses/${property.id}`} key={property.id}>
